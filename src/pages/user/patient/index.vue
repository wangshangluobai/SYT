    ...
    <div
      ...
      <el-form style="width: 60%; margin: 10px auto">
        <el-form-item label="用户姓名">
          <el-input
            ...
            v-model="userParams.name"></el-input>
        </el-form-item>
        ...
        <el-form-item label="证件号码">
          <el-input
            ...
            v-model="userParams.certificatesNo"></el-input>
        </el-form-item>
        ...
        <el-form-item label="手机号码">
          <el-input
            ...
            v-model="userParams.phone"></el-input>
        </el-form-item>
      </el-form>
      ...
      <el-form style="width: 60%; margin: 10px auto">
        ...
        <el-form-item label="详细地址">
          <el-input
            ...
            v-model="userParams.address"></el-input>
        </el-form-item>
      </el-form>
      ...
      <el-form
        ...
        <el-form-item label="用户姓名">
          <el-input
            placeholder="请你输入用户姓名"
            v-model="userParams.contactsName"></el-input>
        </el-form-item>
        <el-form-item label="证件类型">
          <el-select
            placeholder="请你选择证件的类型"
        ...
        <el-form-item label="证件号码">
          <el-input
            placeholder="请你输入证件号码"
            v-model="userParams.contactsCertificatesNo"></el-input>
        </el-form-item>
        <el-form-item label="手机号码">
          <el-input
            placeholder="请你输入用户手机号码"
            v-model="userParams.contactsPhone"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button
            type="primary"
...
<script setup lang="ts">
  ...
  //存储全部就诊人的信息
  let userArr = ref<PatientUserContainer>([])
